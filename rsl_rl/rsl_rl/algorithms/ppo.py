...
class PPO:
    ...
    def update(self):  # noqa: C901
        ...
        for batch_idx, (
            ...
            if debug_logs:
                print(f"[DEBUG][ppo.update] batch_start idx={batch_idx} obs_batch={tuple(obs_batch.batch_size)}", flush=True)
            ...
            self.optimizer.step()
            if debug_logs:
                print(f"[DEBUG][ppo.update] batch_done idx={batch_idx}", flush=True)
            # -- For RND
