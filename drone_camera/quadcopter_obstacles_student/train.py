...
for path in (ROOT_DIR, ENV_DIR, RSL_RL_DIR, *ISAACLAB_SOURCE_DIRS):
...
def _bootstrap_repro_env(seed: int) -> None:
    ...
    python_paths = [path for path in (ROOT_DIR, ENV_DIR, RSL_RL_DIR, *ISAACLAB_SOURCE_DIRS) if os.path.isdir(path)]
