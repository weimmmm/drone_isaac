...
DEFAULT_CHECKPOINT = "/home/wei/End_to_end/logs/rsl_rl/quadcopter_obstacles_refiner/latest/model_0.pt"
...
parser.add_argument(
    "--metrics_out",
    type=str,
    default="/home/wei/End_to_end/logs/rsl_rl/quadcopter_obstacles_refiner/eval_refiner_metrics.txt",
)
