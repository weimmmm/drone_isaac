...
# Match the current OmniNxt asset mass used in simulation.
#CF_MASS = 0.85  # kg
CF_MASS = 0.6385  # kg
...
# Thrust per motor (N)
# Assume ~2x hover thrust margin unless measured values are known.
THRUST_MAX = CF_MASS * GRAVITY / 2.0
# Keep min thrust ratio consistent with previous model (~5.34% of max).
THRUST_MIN = THRUST_MAX * (0.02136263065537499 / 0.4)

# =============================================================================
# Attitude command limits
# =============================================================================

# Max attitude angles (degrees)
ATTITUDE_ROLL_MAX_DEG = 30.0
...
# Max total thrust command (Newtons, all motors)
ATTITUDE_THRUST_MAX_N = 4.0 * THRUST_MAX
...
# Scaled by mass ratio (0.85 / 0.05 = 17x). Adjust if CAD provides exact inertia.
INERTIA_XX = 3.672e-4  # kg*m^2
INERTIA_YY = 3.672e-4  # kg*m^2
INERTIA_ZZ = 7.361e-4  # kg*m^2
...
PID_POS_VEL_X_MAX = 2.0
PID_POS_VEL_Y_MAX = 2.0
...
PID_VEL_THRUST_BASE = (CF_MASS * GRAVITY) / (4.0 * THRUST_MAX) * 65535.0
PID_VEL_THRUST_MIN = PID_VEL_THRUST_BASE * (20000.0 / 30000.0)
